...
pub contract Story: FungibleToken {
    // TokensInitialized
    //
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        destroy() {
            Story.totalSupply = Story.totalSupply - self.balance
            if(self.balance > 0.0) {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @Story.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
                amount <= self.allowedAmount: "Amount minted must be less than the allowed amount"
            }
            Story.totalSupply = Story.totalSupply + amount
