...
import { deployKaratNFT, setupKaratNFTOnAccount } from "./karat-nft";

/*
 * Deploys Karat, KaratNFT and KaratItemsMarket contracts to KaratAdmin.
...
export const setupMarketplaceOnAccount = async (account) => {
	...
	await setupKaratNFTOnAccount(account);
